    ...
    \only<1>{
        \begin{itemize} 
            \item \structure {What Fuzzing is?}
                \\ \textbf{Defination:} In programming and software development, fuzzing or fuzz testing is an automated software testing technique that involves providing invalid, 
                unexpected, or random data as inputs to a computer program\cite{wiki}.
